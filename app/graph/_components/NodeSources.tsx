  ...
  if (state === "loading") {
    return (
      <div className="px-4 py-3 border-b border-border">
        <h4 className="text-xs font-bold mb-2 text-text-muted">출처</h4>
            ...
            {group.items.map((s) => (
              ...
              >
                <div className="flex items-center gap-1.5 text-[10px] text-text-muted mb-0.5">
                  ...
                  {s.contentType !== "text" && (
                    <span className="rounded bg-yellow-100 text-yellow-800 px-1">
                ...
                <p className="text-[11px] leading-relaxed text-text-primary line-clamp-3">
                  {s.content}
                </p>
              </li>
            ))}
