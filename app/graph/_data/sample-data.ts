...
const edges: GraphEdge[] = [
  { id: "e0", source: "p2", target: "p1", type: "citation", label: "Transformer 아키텍처 활용" },
  { id: "e1", source: "p3", target: "p1", type: "citation", label: "Transformer 디코더 확장" },
  { id: "e2", source: "p4", target: "p1", type: "citation", label: "Self-Attention을 비전에 적용" },
  { id: "e3", source: "p4", target: "p5", type: "citation", label: "CNN 베이스라인 비교" },
  { id: "e4", source: "p7", target: "p4", type: "citation", label: "비전 인코더로 ViT 사용" },
  { id: "e5", source: "p7", target: "p3", type: "citation", label: "텍스트 인코더로 GPT 계열 참조" },
  { id: "e6", source: "p2", target: "p3", type: "citation", label: "사전학습 패러다임 공유" },
  { id: "e7", source: "p1", target: "c1", type: "contains", label: "핵심 메커니즘" },
  { id: "e8", source: "p1", target: "c2", type: "contains", label: "제안 아키텍처" },
  { id: "e9", source: "p2", target: "c2", type: "contains", label: "인코더 활용" },
  { id: "e10", source: "p2", target: "c3", type: "contains", label: "미세조정 패러다임" },
  { id: "e11", source: "p2", target: "c4", type: "contains", label: "MLM 사전학습" },
  { id: "e12", source: "p3", target: "c2", type: "contains", label: "디코더 활용" },
  { id: "e13", source: "p3", target: "c4", type: "contains", label: "대규모 사전학습" },
  { id: "e14", source: "p4", target: "c1", type: "contains", label: "패치 Self-Attention" },
  { id: "e15", source: "p4", target: "c5", type: "contains", label: "CNN 대체" },
  { id: "e16", source: "p5", target: "c5", type: "contains", label: "핵심 구조" },
  { id: "e17", source: "p5", target: "c6", type: "contains", label: "핵심 기여" },
  { id: "e18", source: "p1", target: "c6", type: "contains", label: "학습 안정화" },
  { id: "e19", source: "p6", target: "c7", type: "contains", label: "생성 메커니즘" },
  { id: "e20", source: "p7", target: "c8", type: "contains", label: "학습 목적함수" },
  { id: "e21", source: "p7", target: "c9", type: "contains", label: "멀티모달 학습" },
  { id: "e22", source: "p1", target: "p4", type: "shared_concept", label: "Self-Attention 공유" },
  { id: "e23", source: "p5", target: "p4", type: "shared_concept", label: "비전 모델 비교" },
  { id: "e24", source: "p2", target: "p3", type: "shared_concept", label: "사전학습 언어모델" },
  { id: "e25", source: "m1", target: "p1", type: "manual", label: "정리 대상" },
  { id: "e26", source: "m1", target: "c2", type: "manual", label: "개념 정리" },
  { id: "e27", source: "m2", target: "p4", type: "manual", label: "비교 분석" },
  { id: "e28", source: "m2", target: "p5", type: "manual", label: "비교 분석" },
  { id: "e29", source: "m3", target: "p6", type: "manual", label: "비교 대상" },
  { id: "e30", source: "d1", target: "p1", type: "manual", label: "발표 참조" },
  { id: "e31", source: "d1", target: "p2", type: "manual", label: "발표 참조" },
  { id: "e32", source: "d1", target: "p3", type: "manual", label: "발표 참조" },
  { id: "e33", source: "d2", target: "p4", type: "manual", label: "프로젝트 참조" },
  { id: "e34", source: "d2", target: "p5", type: "manual", label: "프로젝트 참조" },
  { id: "e35", source: "p6", target: "p7", type: "similarity", label: "생성 모델 비교" },
];
